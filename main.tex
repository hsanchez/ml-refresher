...
\begin{frame}[fragile]{\textbf{Q. Can you give an example of Supervised Learning?}}
  ...
  \begin{wideitemize}
    ...
    pieces of data; e.g., a plane separating A from B.
    \begin{wideitemize}
...
\begin{frame}[fragile]{\textbf{Q. What more can you say about SVM?}}
  ...
  \begin{wideitemize}
    ...
    \item Hyperparameter and hyperparameter tuning:
    \begin{wideitemize}
     \item $C$ is regularization parameter that controls the trade-off between smooth decision
...
\begin{frame}[fragile]{\textbf{Q. What is cross-validation? I.e., Holdout test set}}
  \begin{wideitemize}
...
\begin{frame}[fragile]{\textbf{Q. Final model selection and evaluation on test set?}}
  \begin{wideitemize}\small
    ...
    \begin{wideitemize}
      ...
      the full data set.
      % So if that validation set was slightly different perhaps we would
